...
RSpec.describe 'bulk discount edit form' do
  ...
  it 'redirects to the bulk discounts show page after filling out and submitting the form' do
    fill_in("percent_discount", with: 15)
    fill_in("qty_threshold", with: 30)
    click_button("Update")
